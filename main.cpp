...
int main() {
    ...
    while (true) {
       ...
       hangman game;
        ...
        int num_length = get_integer("How long would you like the word to be?");
        cout << endl;

        while (!game.start_new_game(num_length, num_guesses)) {
           num_length = get_integer("Error: No words of that length.\nHow long would you like the word to be?");
           cout << endl;
        }
        game.showRemainingWords = get_yesno("Would you like to see the number of remaining words?");
        cout << endl;
        ...
        while (!game.is_won() && !game.is_lost()) {
           ...
           if (game.showRemainingWords) {
              cout << "There are " << game.wordsLength() << " words remaining.\n\n";
           }
            ...
            if (game.is_lost()) {
                cout << "Oh no! You lost!!! The correct word was " << game.hiddenWord() << endl;
            }
        }
